""" Credit to debadridtt on github: https://github.com/debadridtt/Scraping-Google-Images-using-Python"""
...
DRIVER_PATH = '/home/aparker/PycharmProjects/PersonalBarkNet/chromedriver'
...
if __name__ == '__main__':
    ...
    queries = ["cedar tree bark", 'spruce tree bark',
               'fir tree bark', ]  # change your set of queries here

    for query in queries:
        wd.get('https://google.com')
        search_box = wd.find_element_by_css_selector('input.gLFyf')
        search_box.send_keys(query)
        links = fetch_image_urls(query, 200, wd)  # 500 denotes no. of images you want to download
        images_path = '/home/aparker/PycharmProjects/PersonalBarkNet/'
        for i in links:
